...
class SphBasicTestSystemSetting : public SphBasicGeometrySetting
{
  ...
  public:
    SphBasicTestSystemSetting(int episode_env) :
...
class SphFishRelaxationTestEnvironment : public SphBasicTestSystemSetting
{
  ...
  public:
    SphFishRelaxationTestEnvironment(int episode_env) :
        SphBasicTestSystemSetting(episode_env),
...
class SphFishRelaxationTest : public SphFishRelaxationTestEnvironment
{
  ...
  public:
    explicit SphFishRelaxationTest(int episode_env) :
        SphFishRelaxationTestEnvironment(episode_env),
...
class SphFishReloadTestEnvironment : public SphBasicTestSystemSetting
{
  ...
  public:
    SphFishReloadTestEnvironment(int episode_env) :
        SphBasicTestSystemSetting(episode_env),
        water_block(sph_system, makeShared<WaterBlock>("WaterBody")),
        fish_body(sph_system, makeShared<FishBody>("FishBody")),
        flap_body(sph_system, makeShared<FlapBody>("FlapBody")),
...
class SphFishReloadTest : public SphFishReloadTestEnvironment
{
  ...
  public: 
    explicit SphFishReloadTest(int episode_env) :
        SphFishReloadTestEnvironment(episode_env),
...
PYBIND11_MODULE(test_2d_flow_stream_around_fish_flap_test_pybind, m)
{
